...
class Matcher {
  constructor(asymmetricMatch, description) {
    ...
    this.$$typeof = /* @__PURE__ */ Symbol.for("vi.asymmetricMatcher");
  }
  toString() {
...
const objectContainsKey = (key) => new Matcher(
  ...
  (actualValue) => anyObject().asymmetricMatch(actualValue) && actualValue[key] !== void 0,
  "objectContainsKey()"
);
